...
let vehiculo = prompt("Ingrese el vehículo (coche, moto, autobus): ");

let kmsRecorridos = Number(prompt("Ingrese  kms recorridos: "));

litrosConsumidos = Number(prompt("Ingrese litros consumidos: "));
...
if (litrosConsumidos <= 100) {
    totalPagar = (precioKm * kmsRecorridos) + 5;
} else {
    totalPagar = (precioKm * kmsRecorridos) + 10;
}
